...
function business_scripts() {
	...
	wp_enqueue_style( 'business-casual', get_template_directory_uri() . '/assets/css/business-casual.css' );
	...
	wp_script_add_data('business-html5shiv', 'conditional', 'It IE 9');

	wp_enqueue_script('business-respond', 'https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js');
	wp_script_add_data('business-respond', 'conditional', 'It IE 9');
